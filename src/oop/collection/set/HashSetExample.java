...
public class HashSetExample {
    public static void main(String[] args) {
        ...
        */
        ...
        // add(객체): Set에 객체를 추가하는 매서드, 중복된 객체는 추가되지 않는다.
        set.add("멍멍이");
        set.add("야옹이");
        set.add("짹짹이");
        set.add("야옹이");
        set.add("컹컹이");
        set.add("쾅쾅이");
        Collections.addAll(set, "멍멍이", "야옹이", "짹짹이", "야옹이", "샥샥이");
        ...
        convertedList.add(1, "멍멍이");
        convertedList.add(2, "쌉쌉이");
