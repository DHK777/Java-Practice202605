...
import oop.collection.printer.ConsolActivityPrinter;
...
public class SprintLogApp {
    public static void main(String[] args) {
        ...
        LearningActivity reading2 = new ReadingLog(
                "Effective Java 6판", 25, Visibility.PRIVATE, "쟝 블로그");
